...
|---|---|---|---:|---|
| a | Valores faltantes y NA | Marcadores de ausencia normalizados a NA sin tocar SIN ESPECIFICAR en area. | 4878 | Uniformar ausencias para analisis reproducible y conservar categorias validas. |
...
| e | Formatos | Validacion de codigo, normalizacion de telefono y bandera de distrito. | 11583 | Aislar formatos problematicos para revision transparente. |
| f | Valores invalidos | Conteo de fuera de dominio en categorias, codigos y telefonos. | 248 | Documentar invalidez sin alterar valores dudosos automaticamente. |
| g | Registros duplicados | Busqueda de duplicados exactos y candidatos parciales con similitud de cadenas. | 13223 | No se elimina automaticamente; se deja evidencia para decision manual. |
